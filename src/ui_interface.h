...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    ADD_SIGNALS_DECL_WRAPPER(OmniBalanceChanged, void, void);

    /** Omni state has been changed. */
    ADD_SIGNALS_DECL_WRAPPER(OmniStateChanged, void, void);
    ...
    ADD_SIGNALS_DECL_WRAPPER(OmniStateInvalidated, void, void);
};
